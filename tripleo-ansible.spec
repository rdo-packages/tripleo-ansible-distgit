...
%changelog
* Mon Aug 30 2021 RDO <dev@lists.rdoproject.org> 2.5.0-1
- Update to 2.5.0

* Thu Jul 22 2021 RDO <dev@lists.rdoproject.org> 2.4.0-1
- Update to 2.4.0

* Thu Jun 03 2021 RDO <dev@lists.rdoproject.org> 2.3.0-1
- Update to 2.3.0
...
# REMOVEME: error caused by commit https://opendev.org/openstack/tripleo-ansible/commit/5b94b88b78ff9a402cfa6b4ea4a5f50507e6a427
